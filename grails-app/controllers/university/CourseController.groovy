        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(
                    ...
                    args: [message(code: 'course.label', default: 'Course'), course.id]
                )
                redirect course
            }
            '*' {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(
                    ...
                    args: [message(code: 'course.label', default: 'Course'), id]
                )
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(
                    ...
                    args: [message(code: 'course.label', default: 'Course'), params.id]
                )
                redirect action: "index", method: "GET"
            }
            '*' {
