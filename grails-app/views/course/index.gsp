...
<div id="content" role="main">
    <div class="container">
        <section class="row">
            <a href="#list-course" class="visually-hidden-focusable" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
            ...
            <div id="list-${propertyName}" class="col-12 content scaffold-list" role="main">
                ...
                <g:if test="${courseCount > params.int('max')}">
                    <div class="btn-toolbar mb-3" role="toolbar" aria-label="Toolbar with button groups">
                        <g:paginate activeClass="active" class="btn" total="${courseCount ?: 0}" />
                    </div>
                </g:if>
            </div>
        </section>
