...
<head>
    ...
    <style>
        ...
        .page-header {
            ...
            margin-bottom: 2rem;
            color: white;
            box-shadow: 0 0.5rem 1rem rgba(245, 87, 108, 0.3);
            position: relative;
            overflow: hidden;
        }
        ...
        .btn-update-custom {
            ...
            transition: all 0.3s ease;
            color: white;
            box-shadow: 0 0.25rem 0.75rem rgba(245, 87, 108, 0.4);
        }
        
        .btn-update-custom:hover {
            transform: translateY(-3px);
            box-shadow: 0 0.5rem 1.5rem rgba(245, 87, 108, 0.5);
            color: white;
        }
...
<div id="content" role="main">
    <div class="container py-4">
        ...
        <div class="form-section">
            ...
            <g:form resource="${this.student}" controller="${controllerName}" method="PUT" class="needs-validation" novalidate="novalidate">
                ...
                <div class="version-info mb-4">
                    <i class="bi bi-info-circle me-1"></i>
                    Version: ${this.student?.version} (Auto-incremented on each update)
                </div>
                ...
                <div class="form-actions">
                    <div class="d-flex align-items-center gap-3 flex-wrap">
                        ...
                        <span class="badge bg-warning bg-opacity-10 text-warning">
                            <i class="bi bi-clock me-1"></i> Last updated: <g:formatDate format="yyyy-MM-dd HH:mm" date="${new Date()}" />
                        </span>
                    </div>
                    <div class="d-flex gap-2">
                        <g:link action="show" id="${this.student?.id}" class="btn btn-outline-custom">
                            <i class="bi bi-eye me-1"></i> View
                        </g:link>
                        <g:link action="index" class="btn btn-outline-custom">
                            <i class="bi bi-x-circle me-1"></i> Cancel
                        </g:link>
                        <button class="btn btn-update-custom" type="submit">
                            <i class="bi bi-check-circle me-2"></i> 
                            ${message(code: 'default.button.update.label', default: 'Update Student')}
                        </button>
                    </div>
                </div>
            </g:form>
        ...
        <!-- Additional Actions Card (Optional) -->
        <div class="mt-4">
                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <span class="text-muted small">
                                <i class="bi bi-dot"></i> All changes are logged
                            </span>
                            <span class="text-muted small">
                                <i class="bi bi-dot"></i> Version control enabled
                            </span>
                        </div>
                        <g:link action="delete" id="${this.student?.id}" class="btn btn-danger-custom btn-sm" onclick="return confirm('Are you sure you want to delete this student?');">
